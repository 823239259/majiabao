...
export default {
  ...
  data() {
    return {
      ...
      isShow: false,
      idList: [],
      imgList: [require("../../assets/images/oil_master/oil_online_banner1.png"), require("../../assets/images/oil_master/oil_online_banner2.png"), require("../../assets/images/oil_master/oil_online_banner3.png"), require("../../assets/images/oil_master/oil_online_banner4.png")],
      activity01: [
        {
          title: '【活动说明】',
