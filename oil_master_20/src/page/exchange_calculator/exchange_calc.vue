...
const configList = {
        CNY: require('../../assets/images/exchange_calculator/cny.png'),
        USD: require('../../assets/images/exchange_calculator/usd.png'),
        EUR: require('../../assets/images/exchange_calculator/eur.png'),
        JPY: require('../../assets/images/exchange_calculator/jpy.png'),
        HKD: require('../../assets/images/exchange_calculator/cny.png'),
        KRW: require('../../assets/images/exchange_calculator/krw.png'),
        GBP: require('../../assets/images/exchange_calculator/gdp.png'),
        TWD: require('../../assets/images/exchange_calculator/cny.png'),
        AUD: require('../../assets/images/exchange_calculator/aud.png'),
    }
export default {
  name: 'index',
  components: {
  ...
  methods: {  
    ...
    getList () {
        pro.axios1().post('GetExchangeRate', {
        })
        .then((res) => {
...
.key_board {
    ...
    .clear_back{
        ...
        @include font(0.36rem,2.4rem,#333);
        border-bottom: 1px solid #dfe4e6;
        background: url('../../assets/images/exchange_calculator/clear_back.png') center center no-repeat;
