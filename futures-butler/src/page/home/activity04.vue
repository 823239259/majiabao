<template>
  ...
  <div>
    <header class="top">
      ...
      <p class="text">活动开始时间 <span class="yellow">2018-09-30</span></p>
    </header>
    <div class="wrap">
      <div class="top_banner"></div>
      <div class="title_box">
        <h3 class="title1">奖励</h3>
      </div>
      <div class="activity_box">
          <p class="text">邀请一个新注册用户即可获得由管家助手发出的大礼包</p>
          <div class="logo_box">
            <img src="../../assets/images/home/logo_yellow.png" alt="logo">
            <span>管家助手大礼包</span>
          </div>
          <p class="text">（领取说明：领奖时请携带邀请截图与注册ID，需一致）</p>
      </div>
      <p class="note">最终活动解释权归期货管家所有</p>
    </div>
  </div>
</template>
...
<script>
  ...
  const list = [
    ...
    {
      title: '【培训时间】',
      content: '10月20日(星期四) 中午 12:00-18:00'
    },
    {
      title: '【培训地点】',
