    ...
    data() {
      return {
        ...
        community: [{
            time: '2018-6-25',
            name: '瞎说大实话',
            img: require('../assets/images/oil_master/person01_icon.png'),
            goodNumbers: 123,
        ...
        },
        {
            time: '2018-6-25',
            name: 'miaohou',
            img: require('../assets/images/oil_master/person02_icon.png'),
            goodNumbers: 123,
        ...
        },
        {
            time: '2018-6-25',
            name: '三千一',
            img: require('../assets/images/oil_master/person03_icon.png'),
            goodNumbers: 123,
