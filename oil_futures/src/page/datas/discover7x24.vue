	...
	export default {
		...
		filters:{
			changTime:function(e){
				return  pro.getDate(e*1000,"y-m-d h:i:s");
	...
	.wrap{
		...
		.list{
			...
			.display_icon{
				...
				width: 0.32rem;
				height: 0.32rem;
				background: url('../../assets/images/message/display_icon_up.png') center no-repeat;
...
.li_kong,.li_hao{
	...
	width: 1rem;
	height: 1rem;
	background: url('../../assets/images/message/likong.png')  center no-repeat;
	background-size: cover;
}
.li_hao{
	background: url('../../assets/images/message/lihao.png')  center no-repeat;
	background-size: cover;
}		
