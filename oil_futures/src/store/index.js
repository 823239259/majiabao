		...
		setklineoption: function(state,strategyData) {
			...
			state.market.option3 = {
				...
				legend:{
			        ...
			        left:10,
					data:[
						{name:"开空",textStyle:{color:"#fff"},icon:'image://static/lib/images/BP.png'},
						{name:"开多",textStyle:{color:"#fff"},icon:'image://static/lib/images/BK.png'},
						{name:"平空",textStyle:{color:"#fff"},icon:'image://static/lib/images/SP.png'},
						{name:"平多",textStyle:{color:"#fff"},icon:'image://static/lib/images/SK.png'},
						{name:"反卖",textStyle:{color:"#fff"},icon:'image://static/lib/images/BF.png'},
						{name:"反买",textStyle:{color:"#fff"},icon:'image://static/lib/images/SF.png'},
					],
			        selectedMode:false,
			   },
				tooltip: {
